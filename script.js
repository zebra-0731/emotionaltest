const pages = [
  ...
  {
    //Question2
    story: "你看著窗外陌生的天空，決定起身外出。踏出門後且走著走著，你不知不覺走到了一個熱鬧的村莊。在村子中央，有一個木製的任務佈告欄，上面飄浮著幾項神秘的初始任務。",
    npc: "請問，你最想靠近哪一張任務卷軸，並伸手觸碰它？",
    options: [
      { text: "✨ 只要動口就可以觸發改變", value: "語靈使者" }, //Option 1
      { text: "📸 成為魔法界大網紅", value: "星燦引流者" },     //Option 2
      { text: "🏰 成為魔法人生導師", value: "迴響探索師" },     //Option 3
      { text: "📹 魔法界的活動主辦人", value: "魔訊主辦師" }    //Option 4
    ]
  },
  {
...
function showResult() {
  ...
  document.getElementById("storyText").innerHTML = `<h2>你是：${data.name}</h2>
    <center><img src="${data.image}" width="50%" /></center>
    <h5>${data.desc}</h5>
